...
- NeoPop UI design with custom components
- Dark mode support
...
- **Settings Screen**: Configure API endpoint, model, and API key
- **History**: View all saved recipes
...
- MVVM architecture
- Custom NeoPop UI components
- Full localization support
- Dynamic color theming for light/dark modes
